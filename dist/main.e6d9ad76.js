...
var test1 = dom.create("<div id=\"hello\"><p>Hello</p></div>");
console.log(test1);
var test2 = dom.create('<div id="second">This div should be added after the \n\'hello\' div.</div>');
var test3 = dom.create('<span id="third">This span element should be added inside div \n\'second\', after the p element.</span>');
...
var deletedList = dom.empty(checkEmpty);
...
var nl = dom.find('#checkFind');
dom.each(nl, function (n) {
...
//# sourceMappingURL=/main.e6d9ad76.map